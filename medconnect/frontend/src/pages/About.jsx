  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      ...
      <div className="text-gray-700 space-y-6 text-base leading-relaxed mb-16">
        <p>
          Welcome to <span className="font-semibold">Medify</span>, your dedicated partner in managing your healthcare journey with ease and efficiency. At Medify, we believe that accessing healthcare should be simple, intuitive, and stress-free. Our platform was created with the vision of revolutionizing how people connect with healthcare providers, ensuring everyone receives the care they need, when they need it.
        </p>
        <p>
          Founded on the principles of innovation, inclusivity, and compassion, Medify strives to break down barriers between patients and healthcare professionals. We aim to empower individuals with the tools and resources necessary to make informed decisions about their health. Whether you are scheduling your first appointment or managing ongoing care, Medify is here to guide you every step of the way.
        </p>
      </div>
      ...
      <div className="space-y-8 mb-16">
        ...
        <div className="text-gray-700">
          ...
          <p><strong>Compassion:</strong> At the heart of Medify is a deep commitment to empathy and understanding. We strive to make our platform a comforting and supportive environment for all users.</p>
      ...
      <div className="space-y-8 mb-20">
        <div className="text-gray-700">
          ...
          <p>
            Medify offers a streamlined appointment scheduling process that fits seamlessly into your busy lifestyle. With just a few clicks, you can book an appointment with a trusted healthcare provider, eliminating the hassle of long wait times and complicated booking procedures.
          </p>
        </div>
        ...
        <div className="text-gray-700">
          ...
          <p>
            Medify tailors your healthcare experience by providing personalized recommendations, reminders, and insights based on your unique health profile. We are committed to helping you stay on top of your health by offering customized solutions that cater to your specific needs.
          </p>
        </div>
        ...
        <div className="text-gray-700">
          ...
          <p>
            Beyond appointment scheduling, Medify offers a comprehensive range of services, including access to digital health records, telemedicine consultations, and health management tools. Our platform is designed to be a one-stop solution for all your healthcare needs.
          </p>
        </div>
      </div>
    </div>
